...
INSERT INTO `sepback`.`magazine` (`id`,`name`,`issn`,`imgpath`,`membershipfee`,`client_id`,`client_secret`,`openaccess`) VALUES ('1', 'Bankarstvo','1264-4556','bankarstvo.jpg','30','ARaJUwD8O9-cjYkit1QgALKUsO3CdX9Bl_eUA6-rsINvxI-IVFeolaSQqSs8ZUEad3D5AGNmY491zGKd','EAvfBEVBG3lushFJX_oPbgn4kmg-9qxwBPLV9f_Dhda6oWCd864DVh-u7qjlB-IF2Jr2ln-jnD9fSX-Y',false);
INSERT INTO `sepback`.`magazine` (`id`,`name`,`issn`,`imgpath`,`membershipfee`,`client_id`,`client_secret`,`openaccess`) VALUES ('2', 'Tehnika','3896-5485','tehnika.jpg','28','Ae_veWhOruZQCZjrHCUBECmnkXvoEhO_vhIZGCkglx1qvqyGkI22FQVRxtfaeJP1CTL2NZMQJZZHyhXc','EJV26g8cD_0Fl4cCafn17KSp8eDuJEVvVEz_PM3IRSzvh64M-pCqAsz3fx_zraNNL5xTI6q0-kTNJ2HO',true);
INSERT INTO `sepback`.`magazine` (`id`,`name`,`issn`,`imgpath`,`membershipfee`,`client_id`,`client_secret`,`openaccess`) VALUES ('3', 'Zaštita prirode','4564-1545','zastitaprirode.jpg','25','AUTAPxDywfXhkA_1NaZkPoAlRWrjGGlBDnmJSLk3BopA1amVYYTWap7ITfdKeaVzceOZIDQDDSTUnER7','ECMSo13_1Yw7J2eL6mNVDIqPV2KKDEJ8QZ6wOVRfZ6gcx_54GnO6cWU-na4G0IYOFbwaePY_vPtXKeFI',false);
...
INSERT INTO `sepback`.`magazine_edition` (`id`,`magazine_id`,`number`,`name`,`pdf`) VALUES ('4', '2','1','Tehnika Broj 1','Tehnika1.pdf');
INSERT INTO `sepback`.`magazine_edition` (`id`,`magazine_id`,`number`,`name`,`pdf`) VALUES ('5', '3','1','Zastita prirode Broj 1','Zastita1.pdf');
...
INSERT INTO `sepback`.`scientific_work` (`id`,`name`,`pdf`,`magazine_id`,`edition_id`) VALUES ('2','2.Trenutni priorotet Bazelskog komiteta-podizanje letvice','2.Trenutni priorotet Bazelskog komiteta-podizanje letvice.pdf','1','1');
